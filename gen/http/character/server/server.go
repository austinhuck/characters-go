...
func New(
	...
	return &Server{
		...
		GetCharacters:   NewGetCharactersHandler(e.GetCharacters, mux, decoder, encoder, errhandler, formatter),
...
func (s *Server) Use(m func(http.Handler) http.Handler) {
	s.GetCharacters = m(s.GetCharacters)
...
func Mount(mux goahttp.Muxer, h *Server) {
	MountGetCharactersHandler(mux, h.GetCharacters)
...
// MountGetCharactersHandler configures the mux to serve the "character"
// service "getCharacters" endpoint.
func MountGetCharactersHandler(mux goahttp.Muxer, h http.Handler) {
...
// NewGetCharactersHandler creates a HTTP handler which loads the HTTP request
// and calls the "character" service "getCharacters" endpoint.
func NewGetCharactersHandler(
	...
	var (
		encodeResponse = EncodeGetCharactersResponse(encoder)
		encodeError    = EncodeGetCharactersError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "getCharacters")
...
// MountGetCharacterHandler configures the mux to serve the "character" service
...
// and calls the "character" service "getCharacter" endpoint.
...
// MountCreateCharacterHandler configures the mux to serve the "character"
...
// request and calls the "character" service "createCharacter" endpoint.
...
// MountUpdateCharacterHandler configures the mux to serve the "character"
...
// request and calls the "character" service "updateCharacter" endpoint.
...
// MountDeleteCharacterHandler configures the mux to serve the "character"
...
// request and calls the "character" service "deleteCharacter" endpoint.
