...
import (
	...
	charactersvr "github.com/austinhuck/characters-go/gen/http/character/server"
	inventorysvr "github.com/austinhuck/characters-go/gen/http/inventory/server"
	itemsvr "github.com/austinhuck/characters-go/gen/http/item/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, characterEndpoints *character.Endpoints, itemEndpoints *item.Endpoints, inventoryEndpoints *inventory.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
